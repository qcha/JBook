# Помощь по разделу 'System Design Interview'
...
Само собеседование подразумевает крайне сжатые сроки, около часа, при достаточно большой задаче. Обычно задача звучит как "Спроектируйте Facebook с миллиардом пользователей за 50 минут". При этом чаще всего интервьюер выступает в роли 'Заказчика', который просто верхнеуровнево что-то описывает в своих желаниях.
...
В нашем случае, мы получили следующие ФТ:
...
Я обычно выделяю это в отдельную рамочку и получается что-то типа:
...
В некоторых собеседоаниях одним из требований (или могут просто спросить) будет соблюдение SLA, поэтому тут также лучше просто примерно представлять табличку с числами доступности.
...
Рекомендую во-первых посмотреть статью [Олега Стрекаловского - Приручая System Design Interview. Как его организовать и как к нему подготовиться](https://habr.com/ru/articles/698734/), где он дает ссылки на многие интересные материалы .

Я бы для подготовки посоветовал посмотреть:
...
7. [Подкаст { между скобок } - Публичное собеседование по System Design](https://youtu.be/78i0nPnV-cs?si=0x9gLEz0ANEtxZux)
8. [Блог Евгения Афонасьева](t.me/afonasev_blog)
9. [Блог System Design World](t.me/system_design_world)
