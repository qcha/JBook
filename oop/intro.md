...
### Зачем это нужно?
Главный вопрос, перед тем, как вы начинаете что-то делать или изучать - это понимать зачем это нужно.
Понимание `ООП` не сделает из вас супер специалиста, не увеличит вашу зарплату в десятки раз и прочее.
Однако оно даст нечто большее - оно даст `понимание`. Понимание многих библиотек, принципов программирования в `Java` и возможность самому писать лучший код.

Давайте немного порассуждаем и ответим на следующий вопрос: Почему вдруг взяли и придумали эту парадигму?
...
Еще я отдельно хочу сказать про [Интерфейс](./interface.md).
...
Точно то же самое и в программировании!


* `Интерфейс` - это набор методов класса, доступных для использования другими классами.

Также, `ООП` обладает несколькими ключевыми чертами.
