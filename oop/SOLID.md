...
Наршуая поведение родительского класса таким образом создаются масштабные проблемы при работе с таким кодом, так как теперь, в зависимости от реализации, индексы элементов считаются по разному.
