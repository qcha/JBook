...
Что довольно логично, раз класс-родитель предоставляет нам свой метод в качестве открытого, то и класс-потомок не может ограничивать доступ к этому методу - иначе изменится интерфейс класса.
...
1. [Статья Евгения Матюшкина aka Skipy](http://skipy.ru/technics/access_modifiers.html)
