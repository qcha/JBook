...
Очевидно, что подобный подход, копирования и вставки, это пагубная, опасная и гневающая богов привычка.
...
Является ли прямоугольник некоей абстрактной фигурой? Скорее всего да. Отношение взаимодействия `is a`.
...
* Композиция
  ...
  существовать( или его существование не имеет смысла).
...
Композиция - это более сильный вариант агрегации. Она означает строгую зависимость между "частью" и "целым".
...
При появлении большого количества наследников внесение правок в родительский класс не так легко и безопасно.
...
* Если объектов-владельцев достаточно много, то создание и уничтожение вместо одного объекта двух или более может пагубно сказаться на производительности.
...
Если вам интересно мое мнение, то я думаю, что множественное наследование не предоставляет настолько незаменимые и необходимые возможности, а потенциальных проблем, имеющих разрушительные последствия, может создать более чем необходимо.
