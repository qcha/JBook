...
![Reference Counting](../images/jcore/garbage_collector/reference_counting.png)
...
![Reference Counting](../images/jcore/garbage_collector/cycle_deps.png)
...
![GC Root](../images/jcore/garbage_collector/gc_root.png)
...
![Tracing](../images/jcore/garbage_collector/tracing.png)
...
![Mark-and-Sweep](../images/jcore/garbage_collector/mark_sweep.png)
...
![Mark-and-Sweep-Compact](../images/jcore/garbage_collector/mark_sweep_compact.png)
...
Исходя из этих предположений логично было бы разделить нашу память на области, в которых бы хранились объекты разных поколений и те области, в которых будут храниться "молодые" объекты, пытаться очищать чаще.
...
![Модель памяти](../images/jcore/garbage_collector/memory_areas.png)
...
![Модель памяти](../images/jcore/garbage_collector/young_collect.png)
