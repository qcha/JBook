...
Разумеется, для этого нужны уникальные значения хэшей, чтобы каждому хэшу в соответствие была своя ячейка. Что происходит, если два разных ключа вернут одинаковое значение хэш-кода и как такие ситуации решаются можно прочитать в статье про устройство [HashMap](../collections/map/hash_map.md)
