...
Это поведение можно добавить как непосредственно в классы, с которыми мы работаем, так и объявить специальный класс, умеющий сравнивать два переданных объекта.
