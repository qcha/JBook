...
В начале идет непосредственно описание, далее тегами вы описываете что за параметры и какого типа принимаются, каково возвращаемое значение и бросаемые исключения.
