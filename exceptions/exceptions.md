...
Самая простая реакция - это возвращать некоторый код ошибки, например, какое-то число.
...
Что делает невозможным пробрасывание проверяемы�� исключений, т.е разработчик **должен** обрабатывать все проверяемые исключения внутри метода `run`.
