...
Так как с `Java 8` использование `lambda` и `stream`-ов распространенная практика, то накладываемые ограничения тоже добавляют отрицательных баллов к необходимости и использованию проверяемых исключений.
