...
Коллекции в `Java` - это динамические структуры данных для хранения объектов. Для того, чтобы понять в чем различие между обычным массивом и колллекциями, надо вспомнить какие ограничения задаются обычным массивом.
