...
* [Советы по коду](#aСоветы-по-коду)
  ...
  * [Не открывайте API класса без необходимости](#Не-открывайте-интерфейс-класса-без-необходимости)
...
* [Общие советы](#Общие-советы)
  ...
  * [Работа с Git](#Аккуратнее-с-коммитами)
  * [Думайте о данных](#Думайте-о-том,-с-чем-вы-работаете)
