...
Можно посмотреть и на [Oracle Code Conventions](https://www.oracle.com/java/technologies/javase/codeconventions-contents.html), однако, это довольно старый документ и, на мой взгляд, Google Style Guide - это стандарт.
